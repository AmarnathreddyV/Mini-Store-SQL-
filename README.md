...
📌 Project Overview
This project involves the design and implementation of a relational database for a retail "MiniStore" system. The goal was to create a robust structure to manage customer relationships, inventory tracking, and sales transactions while extracting meaningful business insights through complex SQL queries.

🏗️ Database Schema
The database, MiniStoreDB, consists of four primary tables:
...
Data Integrity: Used PRIMARY KEY, FOREIGN KEY (with CASCADE actions), and CHECK constraints to ensure data validity.
...
The included SQL script provides answers to critical business questions, such as:
...
🚀 How to Use
Ensure you have a MySQL-compatible environment installed.
